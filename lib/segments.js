...
export const TEMPERATE = {
  fog:     new THREE.Color(0xc0e3e3),
  skyTop:  new THREE.Color(0xa9d7e1),
  skyMid:  new THREE.Color(0xd4ecef),
  skyBot:  new THREE.Color(0xf2e6cf),
  sun:     new THREE.Color(0xfff2c8),
  sunDir:  new THREE.Vector3(-0.35, 0.42, -1).normalize(),
  hemiSky: new THREE.Color(0xf2e8d4),
  hemiGround: new THREE.Color(0x6ba48e),
  keyColor:  new THREE.Color(0xfff0d6),
};

export const CANYON = {
  fog:     new THREE.Color(0xebbf95),   // warm haze
  skyTop:  new THREE.Color(0xe6c590),
  skyMid:  new THREE.Color(0xf3d5a4),
  skyBot:  new THREE.Color(0xf2a875),
  sun:     new THREE.Color(0xffd28a),
  sunDir:  new THREE.Vector3(-0.30, 0.36, -1).normalize(),
  hemiSky: new THREE.Color(0xf2c6a0),
  hemiGround: new THREE.Color(0xa55c3a),
  keyColor:  new THREE.Color(0xffd2a0),
};
