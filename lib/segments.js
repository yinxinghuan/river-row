...
// Sky gradient is intentionally SHALLOW (user requested "浅浅的渐变") —
// top/mid/bot stay within a narrow value range so there's no harsh band.
export const TEMPERATE = {
  fog:     new THREE.Color(0xd4eaeb),
  skyTop:  new THREE.Color(0xb8dde4),
  skyMid:  new THREE.Color(0xd5ecef),
  skyBot:  new THREE.Color(0xeaf4f0),   // near-white horizon, no warm cream band
  sun:     new THREE.Color(0xffffff),
  sunDir:  new THREE.Vector3(-0.35, 0.42, -1).normalize(),
  hemiSky: new THREE.Color(0xf2f5e9),
