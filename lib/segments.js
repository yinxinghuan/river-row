...
// Canyon palette — desert noon sky: deep warm copper at zenith, hazy warm
// peach band at mid, near-cream at the horizon. Matches the temperate sky's
// vertical depth so the gradient stays readable instead of reading as one tan
// wash from top to bottom.
export const CANYON = {
  fog:     new THREE.Color(0xf3d6b4),
  skyTop:  new THREE.Color(0xc88a5c),     // warm copper / dusty deep
  skyMid:  new THREE.Color(0xe8b88a),     // mid daytime warm peach
  skyBot:  new THREE.Color(0xf6dfb7),     // light warm cream horizon
