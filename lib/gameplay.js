...
const BOOST_VZ           = -23.0;   // forward speed while riding the speed lane
const VZ_LERP            = 2.2;     // how fast vz tracks the target speed
const STEER_MAX_VX       = 10.0;    // peak lateral m/s when finger is pinned to the edge
...
const LANE_PULL_ACCEL    = 9.5;     // m/s² toward laneX at the edge of influence
