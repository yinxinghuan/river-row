...
// ── camera (play) — pulled back for the new stroke mechanic so the player
// can read obstacles ahead while planning a stroke ───────────────────────
const CAM_HEIGHT     = 5.4;
const CAM_BACK       = 9.2;
const CAM_LOOK_AHEAD = 24.0;
const CAM_LOOK_Y     = 0.5;
const CAM_LERP       = 7.0;

// ── camera (preroll cinematic — even further back to show the whole scene)
const CAM_PREROLL_HEIGHT     = 4.4;
const CAM_PREROLL_BACK       = 12.0;
