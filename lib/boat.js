...
export function attachRower(boat, characterKey, CHARACTERS) {
  ...
  // Stand the rower ON the boat floor. Floor top is at boat-local y = 0.13;
  // the character's feet are at character-local y = 0 so rower.y = 0.13
  // places the feet on the floor and the rest of the body towers above
  // the rim (user wanted: "往上一点站在船上的感觉").
  rower.position.set(boat.userData.seatPos.x, 0.13, boat.userData.seatPos.z);
  // very small forward lean over the oars
  rower.rotation.x = 0.06;
