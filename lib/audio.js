...
export function createAudio() {
  ...
  function ambience(on) {
    ...
    if (on && !ambSources) {
      ...
      flowSrc.start();
      flowGain.gain.linearRampToValueAtTime(0.18, c.currentTime + 1.0);
      ...
      rumbleSrc.start();
      rumbleGain.gain.linearRampToValueAtTime(0.075, c.currentTime + 1.0);
  ...
  function setFlow(speedNorm) {
    ...
    ambSources.flowGain.gain.setTargetAtTime(0.16 + s * 0.20, t, 0.18);
    ambSources.flowBp.frequency.setTargetAtTime(1050 + s * 700, t, 0.18);
  }
